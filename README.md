...
8. [`docs/CHANNEL_LAUNCH.md`](docs/CHANNEL_LAUNCH.md) — исследование, решения, реализация и QA рабочего YouTube-канала.
9. [`archive/`](archive/) — исторические материалы, не являющиеся текущим контекстом.
